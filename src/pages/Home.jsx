...
import Reliability from '../components/ReliabilitySolutions'
  ...
  return (
    <>
      <div className="hero-section" >
        <div className="tint">
          <h1 className="heroHeading">Your Trusted Lubrication Reliability Provider</h1>
          <div className="subHead">
            <p>Proud to represent the <a href="https://www.lelubricants.com/">LE</a> brand in India</p>
          </div>
        </div>
      </div>
